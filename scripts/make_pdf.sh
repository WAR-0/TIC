...
# Run from project root: ./scripts/make_pdf.sh

echo "Generating TIC PDF for arXiv submission..."

# Option 1: If you have pandoc
if command -v pandoc &> /dev/null; then
    pandoc manuscript/TIC_manuscript.md -o TIC.pdf --pdf-engine=xelatex
    echo "PDF created using pandoc: TIC.pdf"
else
    echo "Pandoc not found. Please use one of these alternatives:"
    echo "1. Copy manuscript/TIC_manuscript.md to https://md2pdf.netlify.app/"
    echo "2. Open manuscript/TIC_manuscript.md in VS Code with Markdown PDF extension"
    echo "3. Paste into Google Docs and export as PDF"
fi

echo ""
echo "Don't forget to:"
echo "1. Open figures/figure1.html in browser and screenshot it"
