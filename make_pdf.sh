...
if command -v pandoc &> /dev/null; then
    pandoc TIC_manuscript.md -o TIC.pdf --pdf-engine=xelatex
    echo "PDF created using pandoc: TIC.pdf"
else
    echo "Pandoc not found. Please use one of these alternatives:"
    echo "1. Copy TIC_manuscript.md to https://md2pdf.netlify.app/"
    echo "2. Open TIC_manuscript.md in VS Code with Markdown PDF extension"
